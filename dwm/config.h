...
static const char *fonts[]          = { "FiraCode Nerd Font:size=11:type=Regular:antialias=true:autohint=true", "Source Han Sans CN:size=11:type=Regular:antialias=true:autohint=true" };
